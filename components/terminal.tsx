        ...
        output: (
          <div className="space-y-2">
            ...
            <p className="font-mono text-white">
              Welcome to xAGENT's cybersecurity portfolio! Type help to see available commands.
            </p>
          </div>
        ),
        timestamp: new Date(),
        ...
        output = (
          <div className="space-y-2 text-white">
            ...
            <ul className="space-y-1">
              <li>
                <span className="text-white font-bold">about</span> - Learn about xAGENT
              </li>
              <li>
    ...
    <div className="flex flex-col h-full">
      <div className="bg-black border border-white/30 rounded-t-md p-2 flex items-center">
        ...
        <span className="text-sm font-mono text-white">
          xagent@cybersec ~ {currentSection ? `/${currentSection}` : ""}
        </span>
      </div>
